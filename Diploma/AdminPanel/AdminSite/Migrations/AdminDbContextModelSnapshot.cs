...
namespace AdminSite.Migrations
{
    ...
    partial class AdminModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdminPanelDataBaseCore.Entities.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("AdminPanelDataBaseCore.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("AdminPanelDataBaseCore.Entities.Patient", b =>
                {
            ...
            modelBuilder.Entity("AdminPanelDataBaseCore.Entities.Token", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("AdminPanelDataBaseCore.Entities.Token", b =>
                {
                    b.HasOne("AdminPanelDataBaseCore.Entities.ApplicationUser", "User")
                        .WithMany("Tokens")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("AdminPanelDataBaseCore.Entities.ApplicationRole")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AdminPanelDataBaseCore.Entities.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
