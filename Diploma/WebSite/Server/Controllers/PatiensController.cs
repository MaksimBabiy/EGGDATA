namespace Server.Controllers
{
    ...
    [Authorize]
    [Route("api/Patients")]
    public class PatiensController : /*TypeController<PatientViewModel, Patient>*/ Controller
    {
        ...
        public PatiensController(IPatientLogic patientLogic, IHostingEnvironment hostingEnvironment)
        {
